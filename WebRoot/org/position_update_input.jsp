...
<body>
	...
	<div id="formwrapper">
		...
		<form action="system/position.action" method="post">
			...
			<fieldset>
				<legend>
					部门岗位信息 <input type="button" value="添加人员" onclick="window.location = 'system/person!addInput.action?parent.id=${id}'"> <input type="button" value="删除本岗位" onclick="window.location = 'system/position!del.action?id=${id}'">
				</legend>
				<div>
				...
				<div class="enter">
					<input name="submit" type="submit" class="buttom" value="保存岗位基本信息" /> <input name="reset" type="reset" class="buttom" value="重置" />
				</div>
			</fieldset>
		</form>
	</div>
