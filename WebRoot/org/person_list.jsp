...
$(function() {
	oTable = $("#personList").dataTable({
		...
		"sAjaxSource" : "system/person!list.action" ,// 如果从服务器端加载数据,这个属性用于指定加载的路径
		"sPaginationType" : "full_numbers",
		"oLanguage" : { // 主要用于设置各种提示文本
			"sProcessing" : "正在处理...", // 设置进度条显示文本
			"sLengthMenu" : "每页_MENU_行 <input type='button' value='添加人员' onclick='addPerson();' /> <input type='button' value='删除人员' onclick='delPerson();' /> <input type='button' value='更新人员' onclick='updatePerson();' />",// 显示每页多少条记录
